...
<p align="center">
  <img src="images/sugar_by_risklevel.png" width="500"/>
</p>
...
| ------------------- | ----------------- | ----------------- | ------------------ |
| **Actual Low (0)**  | 25                | 20 _(FP)_         | 2                  |
| **Actual Mid (1)**  | 9 _(FN)_          | 15                | 2                  |
| **Actual High (2)** | 5 _(FN)_          | 4                 | 9                  |
...
<p>
 <img src="images/model_selection.png" alt="Perbandingan Akurasi Model" width="600"/>
</p>
...
- Setelah dilakukan tuning, **Random Forest** tidak hanya unggul di akurasi, tapi juga memiliki _f1-score_ yang baik di kelas penting (seperti kelas 2 / high risk).
